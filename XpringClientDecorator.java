...
/**
 * A common interface shared between Xpring Client and the internal hierarchy of decorators
 */
public interface XpringClientDecorator {
     ...
     * @throws XpringKitException If the given inputs were invalid.
     */
    String send(final BigInteger amount, final String destinationAddress, final Wallet sourceWallet) throws XpringKitException;
